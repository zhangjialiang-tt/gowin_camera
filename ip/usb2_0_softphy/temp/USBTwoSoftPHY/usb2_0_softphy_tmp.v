...
//Device: GW2ANR-18
//Device Version: C
//Created Time: Wed Jun  4 16:16:40 2025

//Change the instance name and port connections to the signal names
//--------Copy here to design--------

	usb2_0_softphy your_instance_name(
		...
		.usb_dxp_i(usb_dxp_i), //input usb_dxp_i
		.usb_dxn_i(usb_dxn_i), //input usb_dxn_i
		.usb_dxp_o(usb_dxp_o), //output usb_dxp_o
		.usb_dxn_o(usb_dxn_o), //output usb_dxn_o
